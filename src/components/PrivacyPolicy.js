  ...
  return (
    <div className='policy'>
      ...
      <h5>
        ...
        <h6>Realizacja zamówionych usług</h6>
      </h5>
      <h5>
      ...
      <h5>
        ...
        <h6>dostępu do danych osobowych Ciebie dotyczących,</h6>
        <h6>ich sprostowania,</h6>
        <h6>usunięcia,</h6>
        <h6>ograniczenia przetwarzania,</h6>
        <h6>oraz przenoszenia danych.</h6>
      </h5>
      <h5>
      ...
      <h2>6. Informacja o plikach cookies</h2>
      <h5>
